...
public final class PestParser implements PestParserConstants {
  ...
  final public TopExp TopExp() throws ParseException {
        TopExp ret;
    ret = AdditiveTopExp();
          {if (true) return ret;}
    throw new Error("Missing return statement in function");
  ...
  final public TopExp AdditiveTopExp() throws ParseException {
        TopExp ret, right;
    ret = MultiplicativeTopExp();
    label_7:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 52:
      ...
      case 52:
        jj_consume_token(52);
        right = MultiplicativeTopExp();
                  ret = new ArithTopExp(ret.line, ret.column,
                                        ret, ArithTopExp.Operator.ADD, right);
        break;
      case 53:
        jj_consume_token(53);
        right = MultiplicativeTopExp();
                  ret = new ArithTopExp(ret.line, ret.column,
                                        ret, ArithTopExp.Operator.SUBS, right);
        break;
      default:
        jj_la1[18] = jj_gen;
        jj_consume_token(-1);
  ...
  final public TopExp MultiplicativeTopExp() throws ParseException {
        TopExp ret, right;
    ret = AtomTopExp();
    label_8:
    while (true) {
      ...
      case 54:
        ...
        right = AtomTopExp();
                  ret = new ArithTopExp(ret.line, ret.column,
                                        ret, ArithTopExp.Operator.MUL, right);
        break;
      case 55:
        jj_consume_token(55);
        right = AtomTopExp();
                  ret = new ArithTopExp(ret.line, ret.column,
                                        ret, ArithTopExp.Operator.DIV, right);
        break;
      default:
        jj_la1[20] = jj_gen;
        jj_consume_token(-1);
  ...
  final public TopExp AtomTopExp() throws ParseException {
        TopExp e;
        Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 53:
      ...
      e = AtomTopExp();
                  {if (true) return new NegTopExp(t.beginLine, t.beginColumn, e);}
      break;
    default:
      jj_la1[21] = jj_gen;
      if (jj_2_7(2)) {
        ...
        case 56:
          ...
          t = jj_consume_token(IDENTIFIER);
          jj_consume_token(56);
                  {if (true) return new LiteralStringExp(t.beginLine, t.beginColumn, t.image);}
          break;
        case 30:
          jj_consume_token(30);
          e = TopExp();
        ...
        case 57:
          ...
          e = TopExp();
          jj_consume_token(57);
                  {if (true) return new SizeTopExp(e.line, e.column, e);}
          break;
        default:
          jj_la1[22] = jj_gen;
          jj_consume_token(-1);
  ...
  final public VarExp VarExp() throws ParseException {
        Token t;
    t = jj_consume_token(IDENTIFIER);
          {if (true) return new VarExp(t.beginLine, t.beginColumn, t.image);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public StringLiteralTrm StringLiteralTrm() throws ParseException {
        Token t;
    jj_consume_token(56);
    t = jj_consume_token(IDENTIFIER);
    jj_consume_token(56);
          {if (true) return new StringLiteralTrm(t.beginLine, t.beginColumn, t.image);}
    throw new Error("Missing return statement in function");
  }

  final public StringSizeTrm StringSizeTrm() throws ParseException {
        Token t;
    jj_consume_token(57);
    t = jj_consume_token(IDENTIFIER);
    jj_consume_token(57);
          {if (true) return new StringSizeTrm(t.beginLine, t.beginColumn, t.image);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8000000,0x0,0x0,0x8000000,0x8009c00,0x8009c00,0x49800380,0x49800380,0x9000,0x8000800,0x0,0x48000080,0x4000,0x48000080,0x0,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x40000080,0x0,0x0,0x49800380,0x1800000,0x0,0x0,0x0,0x0,0x0,0x48000080,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x1,0x8,0x0,0x302,0x302,0x3202000,0x3202000,0x2,0x300,0x8,0x3202000,0x0,0x3200000,0x2000,0x0,0xfc000,0x300000,0x300000,0xc00000,0xc00000,0x200000,0x3000000,0xc000000,0x2000,0x3200000,0x0,0xfc000,0x300000,0x300000,0xc00000,0xc00000,0x3200000,0x20000000,};
   }
